...
<div style="max-width: 1500px; margin:auto; display:flex;margin-top:40px;position:relative;justify-content:center; flex-wrap:wrap">
    ...
    <div id="my-keen-slider" class="keen-slider" style="margin-top: 20px; max-width:1700px; margin:auto;width:90%;margin-left:5%;margin-right:5%">
        ...
        <div class="keen-slider__slide">
            ...
            <img src="/images/oxygen1 (1).jpg" alt="">
        </div>
        <div class="keen-slider__slide">
            <div style="position: absolute">
            ...
            <img src="/images/oxygen1 (2).jpg" alt="">
        </div>
        <div class="keen-slider__slide">
            <div style="position: absolute">
            </div>
            <img src="/images/oxygen1 (3).jpg" alt="">
            
        </div>
    </div>
    <div style="width:100%;margin-top:2%;margin-left:10%;"">
        <h2 style="max-width:90%;text-align: justify;margin-top:50px;font-weight:bold">Objective of OMBR </h2>
    <img src="/images/harin-oxygen.png" style="width: 90%;height:auto;margin-top:70px;margin-bottom:100px">
